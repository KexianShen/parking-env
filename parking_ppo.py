...
def make_env(env_id, seed, idx, num_frame_stack, capture_video, run_name):
    def thunk():
        env = gym.make(
            id=env_id,
        ...
        env = gym.wrappers.FrameStack(env, num_frame_stack)
...
if __name__ == "__main__":
    ...
    # try:
    #     agent = torch.load("ppo.pth").to(device)
    # except:
    #     pass
