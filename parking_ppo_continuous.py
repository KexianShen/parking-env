...
def make_env(env_id, seed, idx, capture_video, run_name):
    def thunk():
        env = gym.make(id=env_id, render_mode="rgb_array", continuous=True)
...
class Agent(nn.Module):
    ...
    def get_action_and_value(self, x, action=None):
        ...
        action_alpha = torch.exp(self.actor_alpha(hidden))
        action_beta = torch.exp(self.actor_beta(hidden))
...
if __name__ == "__main__":
    ...
    try:
        agent.load_state_dict(torch.load("ppo_continuous.pth"))
    except:
        pass
